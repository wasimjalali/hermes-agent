...
BUILD_GUIDANCE = (
    ...
    "Tailwind, shadcn/ui, Convex) and a real scaffold.\n"
    "2. Never invent visual decisions. Read the design system. No raw hex, no "
    "arbitrary spacing.\n"
    "3. Never call work done because it compiled.\n"
    "The full verification ladder (typecheck, lint, fix/guard tests, build, "
    "render, design gate) arrives in phase B2. Until then the bar is "
    "`npx tsc --noEmit` clean plus lint clean for the files you touched. "
