...
it. Against upstream, ``config.py`` now carries a three-line import block and
a two-line append rather than a fifteen-line constant in the middle of the
file, so an upstream merge has less to collide with.
